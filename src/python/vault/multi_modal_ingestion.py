"""
Layer 3: VAULT – Multi-Modal Ingestion
Handles PDF, video, audio, and document ingestion.
Tools: Docling / Marker (PDF), yt-dlp (YouTube), Whisper (audio).
Called from Rust vault/ingestion_handler.rs via PyO3.
"""
import os
